...
type telegramInstanceConfig struct {
	...
	// LOCAL FIX START: telegram allow_bot_messages config propagation
	AllowBotMessages bool `json:"allow_bot_messages,omitempty"`
	// LOCAL FIX END: telegram allow_bot_messages config propagation
...
func buildChannel(name string, creds json.RawMessage, cfg json.RawMessage,
	...
	tgCfg := config.TelegramConfig{
		...
		// LOCAL FIX START: telegram allow_bot_messages config propagation
		AllowBotMessages: ic.AllowBotMessages,
		// LOCAL FIX END: telegram allow_bot_messages config propagation
